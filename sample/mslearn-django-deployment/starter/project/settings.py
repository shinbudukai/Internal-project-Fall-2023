...
ALLOWED_HOSTS = ["django-deploy.azurewebsites.net"]

#allows login as admin
CSRF_TRUSTED_ORIGINS = ["https://django-deploy.azurewebsites.net"]
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql_psycopg2',
        'NAME': "postgres",
        'HOST': "django-deploy2.postgres.database.azure.com" ,
        'USER': "hieudang",
        "PORT":"5432",
